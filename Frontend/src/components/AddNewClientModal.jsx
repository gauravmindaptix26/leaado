...
export default function AddNewClientModal({ open, onClose }) {
  if (!open) return null;
        ...
        <div className="flex flex-col md:flex-row">
          <div className="flex-1 px-10 py-8">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <button className="flex-1 min-w-[200px] bg-[#0061FF] text-white py-3 rounded-xl font-semibold shadow hover:bg-[#004fd1] transition">
                START LEAD GENERATION
              </button>
              <button className="flex-1 min-w-[200px] bg-[#E7F0FF] text-[#0047A6] py-3 rounded-xl font-semibold">
                ADD BULK LEADS
              </button>
              <button
                type="button"
